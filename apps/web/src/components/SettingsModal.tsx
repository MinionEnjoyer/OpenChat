  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Voice & Video */}
        <VoiceSettings audio={audio} label={label} input={input} />
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            {([
              ...
              <button
                ...
                style={{
                  padding: '8px 12px', borderRadius: 6, cursor: 'pointer', fontWeight: 600, fontSize: 13,
        ...
        {/* Profile Picture — hidden when Share (image hosting) is unconfigured */}
        {shareBaseUrl && (
        <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
          <button
            onClick={onClose}
            style={{ padding: '10px 16px', borderRadius: 4, border: 'none', background: 'transparent', color: 'var(--text)', cursor: 'pointer' }}
          >
            Cancel
          </button>
          <button
